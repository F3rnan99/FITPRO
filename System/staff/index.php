...
<head>
        <title>ADMIN | FITPRO</title><meta charset="UTF-8" />
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/icontest3.png" alt="Logo" /></h3></div>
                ...
                <div class="form-actions center">
                    ...
                    <button type="submit" class="btn btn-block btn-large btn-warning" title="Log In" name="login" value="Admin Login">Iniciar Sesión</button>
                </div>
            </form>
            <?php
            ...
            <a href="../index.php"><h6>Login | Admin</h6></a>
            </div>

            <div class="pull-right">
            <a href="../customer"><h6>Login | Cliente</h6></a>
            </div>
