...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="payment.php">Pagos</a> <a href="#" class="current">Buscar Resultados</a> </div>
        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=".$row['user_id']."'><button class='btn btn-success btn-mini'><i class='icon icon-money'></i> Pago Realizado</button></a></div></td>
