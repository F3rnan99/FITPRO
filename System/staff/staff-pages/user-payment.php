...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="payment.php">Pagos</a> <a href="#" class="current">Invoice</a> </div>
          ...
          <div class="widget-content">
              ...
              <div class="span5">
                <table class="">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td >Email: support@fitpro.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="row-fluid">
             ...
             <input type="hidden" name="id" value="<?php echo $row['user_id'];?>">
                  ...
                  <button class="btn btn-success btn-large" type="SUBMIT" href="">Pago Realizado</button> 
				</div>
