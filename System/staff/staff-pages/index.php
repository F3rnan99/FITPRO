...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Estás Qauí" class="tip-bottom"><i class="icon-home"></i> Inicio</a></div>
  </div>
<!--End-breadcrumbs-->
      ...
      <div class="center">
        <ul class="stat-boxes2">
          <li>
            ...
            <div class="right"> <strong><?php include 'dashboard-usercount.php' ?></strong> Registrado </div>
          </li>
          <li>
            <div class="left peity_line_neutral"><span><span style="display: none;">10,15,8,14,13,10,10,15</span>
              <canvas width="60" height="24"></canvas>
              </span>17.8%</div>
            <div class="right"> <strong>$<?php include 'income-count.php' ?></strong> Ganancias Totales </div>
          </li>
          <li>
            <div class="left peity_bar_bad"><span><span style="display: none;">3,5,6,16,8,10,6</span>
              <canvas width="60" height="24"></canvas>
              </span>-40%</div>
            <div class="right"> <strong><?php include 'actions/count-trainers.php' ?></strong> Entrenadores Activos</div>
          </li>
          <li>
            <div class="left peity_line_good"><span><span style="display: none;">12,6,9,23,14,10,17</span>
              <canvas width="60" height="24"></canvas>
              </span>+5%</div>
            <div class="right"> <strong><?php include 'actions/count-equipments.php' ?></strong>Equipos </div>
          </li>
          <li>
            ...
            <ul class="recent-posts">
              ...
              <?php
                ...
                while($row=mysqli_fetch_array($result)){
                  ...
                  echo"<span class='user-info'> Por: Administrador / Fecha: ".$row['date']." </span>";
              ...
              ?>
                ...
                <button class="btn btn-warning btn-mini">Ver Todo</button>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="span6">
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-tasks"></i></span>
            <h5>Listas de tareas pendientes del cliente</h5>
          </div>
            ...
            <div class="todo">
              ...
              <?php
                ...
                <li class='clearfix'> 
                    ...
                    <div class='txt'> <?php echo $row["task_desc"]?> <?php if ($row["task_status"] == "Pending") { echo '<span class="date badge badge-important">Pendiente</span>';} else { echo '<span class="date badge badge-success">En Progreso</span>'; }?></div>
