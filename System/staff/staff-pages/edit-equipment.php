...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#" class="current">Lista de Equipos</a> </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-striped'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='edit-equipmentform.php?id=".$row['id']."'><i class='icon icon-pencil'></i></a></div></td>
