...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Administrar Equipos</a> <a href="#" class="current">Actualizar Equpos</a> </div>
                ...
                echo"<div class='container-fluid'>";
                    ...
                    echo"<div class='widget-title'> <span class='icon'> <i class='icon-info-sign'></i> </span>";
                        ...
                        echo"<div class='widget-content'>";
                            ...
                            echo"<h3>Se produjo un error al actualizar los datos.</h3>";
                ...
                echo"<div class='container-fluid'>";
                    ...
                    echo"<div class='widget-title'> <span class='icon'> <i class='icon-info-sign'></i> </span>";
                        ...
                        echo"<div class='widget-content'>";
                            ...
                            echo"<p>Los datos registrados están actualizados. Por favor haga clic en el botón para regresar.</p>";
