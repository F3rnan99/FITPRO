...
<form role="form" action="index.php" method="POST">
    <?php 
                    ...
                    <td class="container" width="600">
                        <div class="content">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <h3 class="text-center">Pago Recibido Exitsamente</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="content-block">
                                                    ...
                                                    <p><i class="fa fa-envelope mr-2"></i> soporte@fitpro.com</p></center>
                                                </td>
                                            </tr>
                            ...
                            <div class="footer">
                                <table width="100%">
                                    <tbody><tr>
                                        <td class="aligncenter content-block"><button class="btn btn-danger" onclick="window.print()"><i class="icon icon-print"></i> Imprimir</button></td>
                                    </tr>
                                </tbody></table>
                            </div></div>
                    </td>
           ...
           <?php } else {?>
            ...
            <div class='error_ex'>
            <h1>409</h1>
            <h3>¡Parece que ha sido desactivada la cuenta del cliente!</h3>
