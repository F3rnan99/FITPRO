      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content">
                ...
                <table class="table table-bordered table-invoice-full">
                  <thead>
                    <tr>
                      ...
                      <th class="head0 right">Asistencias</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php echo $row['plan']; ?> Mes/es</div></td>
                      <td><div class="text-center"><?php echo $row['address']; ?></div></td>
                      <td><div class="text-center"><?php echo '$'.$row['amount']; ?></div></td>
                      <td><div class="text-center"><?php echo $row['attendance_count']; ?> Día/s</div></td>
                    </tr>
                  </tbody>
                </table>
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h4>Último Pago:  $<?php echo $row['amount']; ?></h4>
                        <em><a href="#" class="tip-bottom" title="Fecha de Registro" style="font-size:15px;">Miembro desde: <?php echo $row['dor']; ?> </a></em> </td>
                        </div>
                    </tr>
                  </tbody>
                </table>
            ...
            <div class="row-fluid">
                <div class="pull-left">
                <h4>Querido miembro <?php echo $row['fullname']; ?>,<br/> <br/>Su membresía es actualmente <?php echo $row['status']; ?>! <br/></h4><p>Gracias por elegir nuestros servicios. - en nombre de todo el equipo</p>
                </div>
