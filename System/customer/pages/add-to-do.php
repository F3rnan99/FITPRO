    ...
    <?php 
        ...
        $result = mysqli_query($con,$qry); //query executes
            ...
            echo"<div class='container-fluid'>";
                ...
                echo"<div class='widget-title'> <span class='icon'> <i class='icon-info-sign'></i> </span>";
                    ...
                    echo"<div class='widget-content'>";
                        ...
                        echo"<a class='btn btn-warning btn-big'  href='index.php'>Regresar</a> </div>";
                    echo"</div>";
                    echo"</div>";
                echo"</div>";
                echo"</div>";
            ...
            echo"<div class='container-fluid'>";
                ...
                echo"<div class='widget-title'> <span class='icon'> <i class='icon-info-sign'></i> </span>";
                    ...
                    echo"<div class='widget-content'>";
                        ...
                        echo"<p>Por favor haga clic en el botón para regresar.</p>";
            ...
            echo"</div>";
                ...
                echo"<h3>USTED NO ESTÁ AUTORIZADO A REDIRIGIR ESTA PÁGINA. Volver as <a href='index.php'> DASHBOARD </a></h3>";
            }
