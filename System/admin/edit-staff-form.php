...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Inicio</a> <a href="staffs.php" class="tip-bottom">Staffs</a> <a href="edit-staff-form.php" class="current">Edit Staff Records</a> </div>
  <h1 class="text-center">Actualizar detalles del personal <i class="fas fa-briefcase"></i></h1>
</div>
          ...
          <form action="edit-staff-req.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block">Nota: Solo los miembros pueden cambiar su contraseña hasta que sea una emergencia.</span>
              </div>
            </div>
            <div class="control-group">
...
<!-- Visit codeastro.com for more projects -->
            <div class="form-actions text-center">
             ...
             <input type="hidden" name="id" value="<?php echo $row['user_id'];?>">
              <button type="submit" class="btn btn-success">Actualizar Detalles</button>
            </div>
