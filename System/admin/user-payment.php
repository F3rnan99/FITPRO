...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Inicio</a> <a href="payment.php">Pagos</a> <a href="#" class="current">Factura</a> </div>
          ...
          <div class="widget-content">
            <div class="row-fluid">
              <div class="span5">
                <table class="">
                  <tbody>
                  <div class="pull-left">
                      <h4>Querido <?php echo $row['fullname']; ?>,<br/> <br/> Tú información de pago es: <br/></h4><p>Gracias por elegir nuestros servicios.</p>
                        <br>  
                    </div>
                    <tr>
              ...
              <div class="span7">
                ...
                <select name="plan" required="required" id="select">
                  ...
                  <td class="width30">Estado del Miembro:</td>
                    <td class="width70">
					<div class="controls">
            ...
            <div class="row-fluid">
             ...
             <input type="hidden" name="id" value="<?php echo $row['user_id'];?>">
                  ...
                  <button class="btn btn-success btn-large" type="SUBMIT" href="">Realizar Pago</button> 
				</div>
