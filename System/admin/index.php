...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">ADMIN | FITPRO</a></h1>
</div>
<!--close-Header-part--> 
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Estás Aquí" class="tip-bottom"><i class="fa fa-home"></i> Inicio</a></div>
  </div>
<!--End-breadcrumbs-->
...
<!--Chart-box-->    
          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                ...
                <li class="bg_lb"><i class="fas fa-calendar-check"></i> <strong><?php include 'actions/count-attendance.php';?></strong> <small>Miembros actuales</small></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="row-fluid">
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="fas fa-chevron-down"></i></span>
            <h5>Miembros registrados del gimnasio por género: descripción general</h5>
          </div>
      ...
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="fas fa-chevron-down"></i></span>
            <h5>Miembros del personal por designación: descripción general</h5>
          </div>
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
              ...
              <a href="manage-announcement.php"><button class="btn btn-warning btn-mini">Ver todo</button></a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="todo">
              ...
              <?php
                ...
                <li class='clearfix'> 
                    ...
                    <div class='txt'> <?php echo $row["task_desc"]?> <?php if ($row["task_status"] == "Pending") { echo '<span class="by label label-info">Pendiente</span>';} else { echo '<span class="by label label-success">En Progreso</span>'; }?></div>
