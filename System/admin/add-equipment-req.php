...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="fa fa-home"></i> Inicio</a> <a href="#" class="tip-bottom">Administrar Miembros</a> <a href="#" class="current">Agregar Miembros</a> </div>
...
if(!$result){
  ...
  echo"</div>";
    ...
    echo"<h3>USTED NO ESTÁ AUTORIZADO A REDIRIGIR ESTA PÁGINA. VOLVER a USTED NO ESTÁ AUTORIZADO A REDIRIGIR ESTA PÁGINA. Volver a<a href='index.php'> DASHBOARD </a></h3>";
}
