...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>Inicio</a> <a href="attendance.php" class="current">Administrar Asistencia</a> </div>
    <h1 class="text-center">Lista de asistencia <i class="icon icon-calendar"></i></h1>
  </div>
