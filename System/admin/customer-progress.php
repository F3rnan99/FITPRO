...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Inicio</a> <a href="customer-progress.php" class="current">Progreso del Cliente</a> </div>
    <h1 class="text-center"> <i class="fas fa-signal"> Actualizar progreso del cliente</i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='update-progress.php?id=".$row['user_id']."'><button class='btn btn-warning btn'> Actualizar Progreso</button></a></div></td>
