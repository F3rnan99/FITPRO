...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Administrar Anuncios <i class="fas fa-bullhorn"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='actions/remove-announcement.php?id=".$row['id']."' style='color:#F66;' ><i class='fas fa-trash'></i> Eliminar</a></div></td>
