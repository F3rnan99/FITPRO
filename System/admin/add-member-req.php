...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Inicio</a> <a href="#" class="tip-bottom">Administrar Miembros</a> <a href="#" class="current">Agregar Miembros</a> </div>
  <h1>Inscribir Miembro Nuevo</h1>
</div>
  ...
  echo"<div class='container-fluid'>";
      ...
      echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-info'></i> </span>";
          ...
          echo"<div class='widget-content'>";
              ...
              echo"<h3>Ocurrió un error al ingresar los datos</h3>";
