...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="reports.php" class="current">Representación gráfica</a> </div>
    <h1 class="text-center">Informe de ingresos y gastos <i class="fas fa-chart-bar"></i></h1>
  </div>
  ...
  <div id="content-header">
    <h1 class="text-center">Informe de miembros registrados <i class="fas fa-chart-bar"></i></h1>
  </div>
  <div class="container-fluid">
  ...
  <div id="content-header">
    <h1 class="text-center">Informe de servicios <i class="fas fa-chart-bar"></i></h1>
  </div>
  <div class="container-fluid">
