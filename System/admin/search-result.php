...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="payment.php">Pagos</a> <a href="#" class="current">Buscar</a> </div>
    <h1 class="text-center">Pago de miembro registrado <i class="fas fa-group"></i></h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class='widget-box'>
          <div class='widget-title'> <span class='icon'> <i class='fas fa-th'></i> </span>
            <h5>Tabla de pagos de miembros</h5>
      ...
      $cnt = 1;
        ...
        if (mysqli_num_rows($result)==0){
            ...
            <h1>403</h1>
            <h3>¡¡Opps, resultados no encontrados!!</h3>
        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=".$row['user_id']."'><button class='btn btn-success btn'><i class='fas fa-dollar-sign'></i> Realizar Pago</button></a></div></td>
