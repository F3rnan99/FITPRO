...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Ir al Inicio" class="tip-bottom"><i class="fas fa-home"></i> Inicio</a> <a href="payment.php" class="current">Pagos</a> </div>
    <h1 class="text-center">Registro de Pagos <i class="fas fa-group"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered data-table table-hover'>
            ...
            <tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='fas fa-dollar-sign'></i> Pago Realizado</button></a></div></td>
                <td><div class='text-center'><a href='sendReminder.php?id=<?php echo $row['user_id']?>'><button class='btn btn-danger btn' <?php echo($row['reminder'] == 1 ? "disabled" : "")?>>Avisar</button></a></div></td>
              </tbody>
          <?php $cnt++; }
