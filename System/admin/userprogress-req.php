                ...
                echo"<div class='container-fluid'>";
                    ...
                    echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-info'></i> </span>";
                        ...
                        echo"<div class='widget-content'>";
                            ...
                            echo"<h3>ESe produjo un error al actualizar sus datos.</h3>";
                            echo"<p>Please Try Again</p>";
                            echo"<a class='btn btn-warning btn-big'  href='customer-progress.php'>Regresar</a> </div>";
                        echo"</div>";
                        echo"</div>";
                    echo"</div>";
                    echo"</div>";
                ...
                echo"<div class='container-fluid'>";
                    ...
                    echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-briefcase'></i> </span>";
                        ...
                        echo"<div class='widget-content'>";
                            echo"<div class='error_ex'>";
                            echo"<h1>Exitoso</h1>";
                            echo"<h3>¡Cambios realizados con éxito!</h3>";
                            echo"<p>El progreso del usuario solicitado ha sido actualizado. Por favor haga clic en el botón para regresar.</p>";
