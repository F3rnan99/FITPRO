...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Inicio</a> <a href="payment.php" class="tip-bottom">Pagos</a> <a href="#" class="current">Realizar Pagos</a> </div>
  <h1>Pagos</h1>
</div>
<form role="form" action="index.php" method="POST">
    <?php 
                                ...
                                <tbody><tr>
                                    <td class="content-wrap aligncenter print-container">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tbody><tr>
                                            <tr>
                                                <td><center><img src="../img/gym-logo.png" alt="Gym Logo" width="100"></center></td>
                                            </tr>
                                                <td class="content-block">
                                                    <h3 class="text-center">Pago Recibido Exitosamente!!</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Factura #<?php echo(rand(100000,10000000));?></div><div style="float:right"> Último Pago: <?php echo $paid_date?></div></td>
                                                        </tr>

                                                        <tr>
                                                        <td class="text-center" style="font-size:14px;"><b>Cliente: <?php echo $fullname; ?></b>  <br>
                                                        Pagado: <?php echo date("F j, Y - g:i a");?>
                                                        </td>
                                                            ...
                                                            <td>
                                                                <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="alignright"><b>Válida hasta</b></td>
                                                                    </tr>
                                                                    
                                                                    
                                                                    <tr>
                                                                        <td><?php echo $services; ?></td>
                                                                        <td class="alignright"><?php echo $plan?> Mes</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td><?php echo 'Total / Mes'; ?></td>
                                                                        <td class="alignright"><?php echo '$'.$amount?></td>
                                                                    </tr>
                                                                   
                                                                    
                                                                    <tr class="total">
                                                                        <td class="alignright" width="80%">Pago Total</td>
                                        ...
                                        <center><h4 class="text-primary mb-4">Encuentranos</h4>
           ...
           <?php } else {?>
            ...
            <p>La cuenta del miembro seleccionado ya no estará ACTIVADA hasta el próximo pago.</p>
         ...
         <?php   }
              ...
              <h3>USTED NO ESTÁ AUTORIZADO A REDIRIGIR ESTA PÁGINA. Volver a<a href='index.php'> DASHBOARD </a></h3>
       <?php }
?>
